...
import com.giovanna.medialab.storage.AppFiles
import com.giovanna.medialab.storage.AppFiles.newPhotoFile
    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                Toast.makeText(context, "Foto guardada como: \n${file.name}", Toast.LENGTH_LONG).show()
            },
